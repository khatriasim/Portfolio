...
const HomeSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex justify-center flex-col items-center py-8 max-w-4xl mx-auto">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="flex gap-4 justify-center mt-10">
          <button 
            ...
            className="bg-blue-600 flex gap-3 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"
          >
          ...
          <button 
            onClick={download} 
            className="border flex gap-3 border-blue-600 text-blue-600 px-6 py-2 rounded-lg hover:bg-blue-50 transition-colors"
          >
